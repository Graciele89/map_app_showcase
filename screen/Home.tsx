...
import MapView, { Callout, LatLng, Marker, PROVIDER_GOOGLE, Overlay } from 'react-native-maps';
import { StyleSheet, View, Dimensions, Text, Touchable, TouchableOpacity, FlatList, Button, ScrollView, Modal } from 'react-native';
